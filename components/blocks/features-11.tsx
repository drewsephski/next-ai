            ...
            <div className="mx-auto max-w-5xl px-6">
                <div className="mx-auto grid gap-2 sm:grid-cols-5">
                    <Card className="group overflow-hidden shadow-black/5 sm:col-span-3 sm:rounded-none sm:rounded-tl-xl">
                        <CardHeader>
                            <div className="md:p-6">
                                <p className="font-medium">Everything You Need in One Platform</p>
                                <p className="text-muted-foreground mt-3 max-w-sm text-sm">Experience the power of our complete SaaS ecosystem - authentication, payments, dashboard, and AI chat all seamlessly integrated for maximum productivity and growth.</p>
                            </div>
                        </CardHeader>
                    ...
                    <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-2 sm:rounded-none sm:rounded-tr-xl">
                        <p className="mx-auto my-6 max-w-md text-balance px-6 text-center text-lg font-semibold sm:text-2xl md:p-6">Launch Faster, Scale Smarter with Our All-in-One Solution</p>
                    ...
                    <Card className="group p-6 shadow-black/5 sm:col-span-2 sm:rounded-none sm:rounded-bl-xl md:p-12">
                        <p className="mx-auto mb-12 max-w-md text-balance text-center text-lg font-semibold sm:text-2xl">Built for Modern SaaS Teams</p>
                    ...
                    <Card className="group relative shadow-black/5 sm:col-span-3 sm:rounded-none sm:rounded-br-xl">
                        <CardHeader className="p-6 md:p-12">
                            <p className="font-medium">Enterprise-Ready Features</p>
                            <p className="text-muted-foreground mt-2 max-w-sm text-sm">From user authentication to payment processing, dashboard analytics to AI-powered chat - everything your SaaS needs to succeed, all in one comprehensive platform.</p>
                        </CardHeader>
